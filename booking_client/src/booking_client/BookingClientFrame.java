...
public class BookingClientFrame extends javax.swing.JFrame {
    ...
    private BookingBrokerAppGateway bookingBrokerGateway;
    ...
    public BookingClientFrame() {
        ...
        holder = new HashMap<>();
        bookingBrokerGateway = new BookingBrokerAppGateway() {
            public void onBookingReply(ClientBookingReply reply, String returnId) {
                  getRequestReply(holder.get(returnId), reply);
    ...
    private ClientListLine getRequestReply(ClientBookingRequest request, ClientBookingReply reply) {
    ...
    private void jbSendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbSendActionPerformed
        ...
        String  id = this.bookingBrokerGateway.submitBookingRequest(request);
